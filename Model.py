...
bodies['ovenbackouter'] = Solid(290, 0.00012, steel, 0.02)
bodies['food'] = Solid(290, 0.0036, hipor, 5)
bodies['ovenwalls'] = Solid(290, 0.00056, steel, 0.001)
bodies['oveninsulation'] = Solid(290, 0.0112, rockwool, 0.02)
bodies['ovenouter'] = Solid(290, 0.00056, steel, 0.001)
bodies['outsideair'] = Surroundings(290, 50)
bodies['outsideairback'] = Surroundings(290, 100)
...
exchangers.append(HeatExchange(bodies['fanshroud'], bodies['ovenair'], 0.006))
